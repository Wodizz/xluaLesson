...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp1(int p0, out int p1, out string p2, out bool p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                p2 = LuaAPI.lua_tostring(L, errFunc + 3);
                p3 = LuaAPI.lua_toboolean(L, errFunc + 4);
		...
		public int __Gen_Delegate_Imp2(int p0, ref int p1, ref string p2, ref bool p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(CustomCallInt))
			{
			    return new CustomCallInt(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(CustomOutCallInt))
			{
			    return new CustomOutCallInt(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(CustomRefCallInt))
			{
			    return new CustomRefCallInt(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(CustomParamsCall))
			{
			    return new CustomParamsCall(__Gen_Delegate_Imp3);
			}
